...
<head>
	...
	<link rel="stylesheet" href="${pageContext.request.contextPath}/rzy/css/bootstrap-theme.min.css" />
	<link rel="stylesheet" href="${pageContext.request.contextPath}/rzy/css/bootstrap.min.css" />
				...
				<div class="collapse navbar-collapse"
					...
					<ul class="nav navbar-nav navbar-right">
						<li class="dropdown"><a href="#" class="dropdown-toggle"
												data-toggle="dropdown" role="button" aria-expanded="false">普通用户 [${requestScope.one.name}]
							<span class="caret"></span>
						</a>
							<ul class="dropdown-menu" role="menu">
								<li><a href="#">个人资料</a></li>
								<li class="divider"></li>
								<li><a href="${pageContext.request.contextPath}/P/exit.do">安全退出</a></li>
							</ul></li>
					</ul>
				</div>
...
<span>菜单</span>
		...
		<div class="col-md-12">
			...
			<table  style="text-align:center" id="userPager"
				...
				<tbody>
				<tr class="bg-danger" >
					<td>${requestScope.one.name}</td>
					<td style="display: none;">123456</td>
					<td>${requestScope.one.phone}</td>
					<td>${requestScope.one.email}</td>
					<td>${requestScope.one.come}</td>
					<td>${requestScope.one.ip}</td>
				</tr>
				</tbody>
